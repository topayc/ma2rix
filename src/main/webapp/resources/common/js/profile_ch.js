...
jQuery(function(){
	...
	$("#plus1").click(function(){
		...
		addMemberLink      += "  <td> <img class='minus1' src='../resources/_images/ico_minus.png' /></td>";
		addMemberLink      += "</tr>";
	...
	$("#plus2").click(function(){
		...
		addSelect += "&nbsp;&nbsp;&nbsp;&nbsp;<img src='../resources/_images/join/ico_minus.png' class='minus2'/></div><br/><div class='clear'></div>";

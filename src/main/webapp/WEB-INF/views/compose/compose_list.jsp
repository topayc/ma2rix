...
<%-- 					<c:forEach var="composeCommand" items="${resultList}"> --%>
<%-- 					<c:set var="pageon" value="1" scope="page"></c:set> --%>
<!-- 						<li class="secType1 oh"> -->
<!-- 							<div class="coverArt">							 -->
<%-- 								<a href="/music/arrange/arrangeDetail?arrangeNo=${composeCommand.composeNo}&listType=${listType}"><img src="${composeCommand.composeImageWeb}" alt="" style="width: 110px; height: 110px;"></a>	 --%>
<!-- 							</div> -->
<!-- 							<div class="soundArea"> -->
<!-- 								<div class="soundHeader"> -->
								
<%-- 									<a class="bulPlay" href="#none" data-sound-title="${composeCommand.composeTitle}" data-sound-url="http://www.jplayer.org/audio/m4a/Miaow-07-Bubble.m4a;http://www.jplayer.org/audio/ogg/Miaow-07-Bubble.ogg"><i class="fa fa-play-circle fa-2x"></i></a> --%>
									
<%-- 									<span class="songTitle"><a href="#none">${composeCommand.composeTitle}</a></span> --%>
<%-- 									<span class="songSinger"><a href="#none">${composeCommand.composeMemberNickName}</a></span> --%>

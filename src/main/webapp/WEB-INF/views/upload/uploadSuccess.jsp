...
<div id="wrap">
    ...
    <div id="container">
		<div id="content">
			<div class="m_com">
				<h3 class="tit wrap">이메일 발송 완료  </h3>
				<div class="pw">
					<div class="t_center">
						<h2 class="mt_20"> 업로드 성공    </h2>
						<h3 class="mt_20"> ${contextPath} : ${realPath} : ${profileImagePath }</h3> <br/><br/><br/><br/>
						<h3 class="mt_20"> 업로드 파일 이름 : ${fileName}</h3>
